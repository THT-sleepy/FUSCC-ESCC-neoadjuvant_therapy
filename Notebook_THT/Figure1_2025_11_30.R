...
if(0){
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency at baseline (%CD8+T)",title="c01_CD4_Tn_TCF7") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency at baseline (%CD8+T)",title="c02_CD4_Tcm_S1PR1") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency at baseline (%CD8+T)",title="c03_CD4_Tcm_ANXA1") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency at baseline (%CD8+T)",title="c04_CD4_Tem_NR4A1") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency at baseline (%CD8+T)",title="c05_CD4_Treg_FOXP3") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency at baseline (%CD8+T)",title="c06_CD4_TOX") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
...
if(0){
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency change (%CD8+T)",title="c01_CD4_Tn_TCF7") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency change (%CD8+T)",title="c02_CD4_Tcm_S1PR1") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency change (%CD8+T)",title="c03_CD4_Tcm_ANXA1") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency change (%CD8+T)",title="c04_CD4_Tem_NR4A1") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency change (%CD8+T)",title="c05_CD4_Treg_FOXP3") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Frequency change (%CD8+T)",title="c06_CD4_TOX") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
...
if(0){
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="freq_dnmcuency change (%CD8+T)",title="c01_CD4_Tn_TCF7") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
  ...
  p <- input %>%
    ...
    geom_point(aes(color=Response), size=1.5, stroke=1, position = position_jitter(width=.15)) +
    theme_pubr() + 
    labs(x="",y="Freqcuency change (%CD8+T)",title="c02_CD4_Tcm_S1PR1") +
    scale_color_manual(values = c('#5778A2','#8A281E'), name='Response') +
    theme(strip.text.x = element_text(size = 15),
          strip.background =element_rect(fill=NA, color = 'black', size = 1), 
          axis.text.x = element_blank(), 
...
## Proportion of major cell types in each sample
...
anno_df = data.frame()
global_df = meta %>% 
  group_by(treatment_stage) %>% 
  summarise(n = n())

sub_df = meta %>% 
  group_by(major_celltype,treatment_stage) %>% 
  summarise(n1 = n())

anno_df= meta %>% 
  tidyr::expand(major_celltype,treatment_stage) %>%
  select(major_celltype,treatment_stage) %>% 
  left_join(sub_df, by=c('major_celltype', 'treatment_stage')) %>% 
  left_join(global_df, by = c('treatment_stage')) %>% 
  replace_na(list(n1=0,n=0)) %>%
  mutate(freq = n1/n) 

input <- anno_df
input$treatment_stage <- factor(input$treatment_stage,levels = c("pre","on","post"))
input$major_celltype <- factor(input$major_celltype,levels = c("Endo","B","Fib","Myeloid","T","Epi"))
input  %>%
  ggplot(aes(x = treatment_stage, y = freq, fill = major_celltype)) +
  geom_bar(stat = "identity", position = "stack") +  # 用 'dodge' 实现分组柱状图
  scale_fill_manual(values = major_cell_colors) + 
...
###亚类
meta = df %>% filter(anatomic_site == 'tumor',minor_celltype != "c41_Epi_Tumor")
anno_df = data.frame()
global_df = meta %>% 
  group_by(treatment_stage) %>% 
  summarise(n = n())
...
sub_df = meta %>% 
  group_by(minor_celltype,treatment_stage) %>% 
  summarise(n1 = n())

anno_df= meta %>% 
  tidyr::expand(minor_celltype,treatment_stage) %>%
  select(minor_celltype,treatment_stage) %>% 
  left_join(sub_df, by=c('minor_celltype', 'treatment_stage')) %>% 
  left_join(global_df, by = c('treatment_stage')) %>% 
  replace_na(list(n1=0,n=0)) %>%
  mutate(freq = n1/n) 
...
input <- anno_df
input$treatment_stage <- factor(input$treatment_stage,levels = c("pre","on","post"))
#input$minor_celltype <- factor(input$minor_celltype,levels = c("Endo","B","Fib","Myeloid","T","Epi"))
input  %>%
  ggplot(aes(x = treatment_stage, y = freq, fill = minor_celltype)) +
  geom_bar(stat = "identity", position = "stack") +  # 用 'dodge' 实现分组柱状图
