...
adata.obs.loc[adata.obs['leiden_res2'] == '15', 'minor_celltype'] = 'c43_prfEC_MKI67'
...
dp.style(dot_edge_color='black', dot_edge_lw=1).savefig("plots/1125_dotplot_EC.png")
```
<img src="..\figures\1125_dotplot_EC.png">
...
adata.obs.loc[adata.obs['leiden_res2'] == '15', 'minor_clt'] = 'c43'

sc.pl.umap(adata,color="minor_clt",legend_loc="on data",title="Endothelial cells\n(n=20954)",palette=palette,save="1125_EC.png")
```
<img src="..\figures\umap1125_EC.png">
