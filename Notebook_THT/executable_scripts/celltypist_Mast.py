...
##
adata = sc.read("RData/Mast__umapmd0.4.h5ad")
...
sc.pl.umap(adata, color=["celltypist_cell_label_coarse", "celltypist_conf_score_coarse"], frameon=False, sort_order=False, wspace=1,save="1122_121celltypist_coarse_Mast.png") 

sc.pl.umap(adata, color=["celltypist_cell_label_fine", "celltypist_conf_score_fine"], frameon=False, sort_order=False, wspace=1,save="1122_121celltypist_fine_Mast.png")
