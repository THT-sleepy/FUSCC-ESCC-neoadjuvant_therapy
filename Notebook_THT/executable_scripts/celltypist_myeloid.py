...
sc.pl.umap(adata, color=["celltypist_cell_label_coarse", "celltypist_conf_score_coarse"], frameon=False, sort_order=False, wspace=1,save="121celltypist_coarse_Myeloid.png") 

sc.pl.umap(adata, color=["celltypist_cell_label_fine", "celltypist_conf_score_fine"], frameon=False, sort_order=False, wspace=1,save="121celltypist_fine_Myeloid.png")

adata = adata[adata.obs.celltypist_cell_label_coarse != 'B cells'].copy()
adata.write("RData/Myeloid cell__umapmd0.4.h5ad")
