...
def process_celltype(adata, celltype_name, save_dir="RData/", plot_prefix=""):
    ...
    for min_dist in [0.4]:
        ...
        # 保存UMAP聚类图
        plot_path = f"{plot_prefix}{celltype_name}_umapmd{min_dist}regressoutmtribo_cluster.png"
        sc.pl.umap(
            adata_md,
        ...
        # 保存AnnData对象
        output_fpath = f"{save_dir}{celltype_name}__umapmd{min_dist}_regressoutmtribo.h5ad"
...
celltypes_to_process = ["CD4+T","NKT_ILC"]
