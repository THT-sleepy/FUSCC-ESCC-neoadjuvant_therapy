...
sc.pl.umap(adata, color=["celltypist_cell_label_coarse", "celltypist_conf_score_coarse"], frameon=False, sort_order=False, wspace=1,save="1122_121celltypist_coarse_MonoMacro.png") 

sc.pl.umap(adata, color=["celltypist_cell_label_fine", "celltypist_conf_score_fine"], frameon=False, sort_order=False, wspace=1,save="1122_121celltypist_fine_MonoMacro.png")

adata.write("RData/Mono_Macro__umapmd0.4.h5ad")
